...
class _BatteryServiceScreenState extends State<BatteryServiceScreen> {
  ...
  final List<Map<String, dynamic>> _batteryServices = [
    {
          ...
          children: [
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: _batteryServices.map((service) {
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: _batteryServices.map((service) {
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            content: const Text(
                              'Your battery service has been booked successfully. You will receive a confirmation shortly.',
                            ),
                            actions: [
                              TextButton(
                                onPressed: () {
